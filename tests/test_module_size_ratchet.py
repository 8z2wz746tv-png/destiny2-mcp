...
CEILINGS = {
    ...
    # （组件 900）+ 来源装配都在这里。再往里加就该拆"目录/账号状态"，而不是抬上限。
    "destiny_mcp/services/pattern_service.py": 360,
    ...
    # 同上：`intent="patterns"` 的载荷与话术（总览 / 单把 / 变体 / 「未开始」措辞）。
    "destiny_mcp/tools/_patterns_branches.py": 182,
}
